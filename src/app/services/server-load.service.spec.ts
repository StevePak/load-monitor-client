...
describe('ServerLoadService', () => {
  ...
  beforeEach(() => {
    ...
    serverLoadService = new ServerLoadService(
  ...
  it('should overload on high load if not overloaded', () => {
    ...
    expect(serverLoadService.overload).toEqual(
  ...
  it('should not overload if overloaded', () => {
    ...
    expect(serverLoadService.overload).not.toEqual(
      new Date(new Date().getTime() + 120000)
    );
  ...
  it('should recover on low load if overloaded', () => {
    ...
    expect(Number(serverLoadService.overload)).toBeLessThanOrEqual(
      Number(new Date())
    );
  });
